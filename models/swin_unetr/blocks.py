...
from monai.networks.blocks.dynunet_block import get_conv_layer #, UnetBasicBlock, UnetResBlock, get_conv_layer
...
class UnetResBlock(nn.Module):
    ...
    def __init__(
        ...
        self.t_proj = torch.nn.Linear(embedding_size, out_channels)
